...
import type { RefereeWithAssignments } from "@/components/uebersicht/running/types";
...
export async function getRefereeWithAssignmentsByProfileIdAndTournamentId(
  profileId: number,
  tournamentId: number,
): Promise<RefereeWithAssignments | undefined> {
