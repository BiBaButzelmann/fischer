...
function buildParticipantInitialValues(
  ...
  if (current) {
    return {
      ...
      dwzRating: prefill?.dwzRating ?? current.dwzRating ?? undefined,
      fideRating: prefill?.fideRating ?? current.fideRating ?? undefined,
      fideId: prefill?.fideId ?? current.fideId ?? undefined,
      birthYear: current.birthYear ?? undefined,
      birthDate: current.birthDate ?? undefined,
      dsbPersonId: prefill?.dsbPersonId ?? current.dsbPersonId ?? undefined,
