            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold">Über das Turniergericht</h3>
                </div>
            ...
            <CollapsibleContent>
              <div className="px-6 pb-6 space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    <strong>Zusammensetzung:</strong> Das Turniergericht setzt
                    sich aus drei Spielern des Klubturniers und zwei Nachrückern
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    ...
                    endgültig über den Protest einer Schiedsrichterentscheidung.
                  </p>
                </div>
              </div>
            </CollapsibleContent>
