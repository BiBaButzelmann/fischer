...
import { ClipboardEdit, Info, Users, ChevronDown } from "lucide-react";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold">Über den Eingabehelfer</h3>
                </div>
              ...
              <div className="px-6 pb-6 space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <p>
                    ...
                    erfolgt durch die Turnierleitung. Wenn es genug
                    Eingabehelfer gibt, können Gruppen auch aufgeteilt werden.
                  </p>
                </div>
                <div className="flex items-start gap-3">
