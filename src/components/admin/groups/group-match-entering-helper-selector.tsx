...
import { MatchEnteringHelperEntry } from "../match-entering-helper/match-entering-helper-entry";
import { AssignmentsDisplay } from "../match-entering-helper/assignments-display";
import {
  Select,
  SelectContent,
  SelectItem,
      ...
      {assignedHelpers.length > 0 && (
        <div className="space-y-1">
          {assignedHelpers.map((helper) => (
            <div key={helper.id} className="px-2 py-1 bg-gray-50 rounded text-xs">
