...
import { formatPlayerName } from "./format-fide-name";
...
describe("formatPlayerName", () => {
  ...
  it("maps German umlauts to digraphs", () => {
    expect(formatPlayerName("Jürgen", "Müller")).toBe("Mueller,Juergen");
    expect(formatPlayerName("FÄÖÜ", "ÄÖÜ")).toBe("AeOeUe,FAeOeUe");
  });
